<!-- Dies ist die Ansicht für den Fragenkatalog Technik-->
@extends('layouts.app')

@section('content')

    <!--Fragen aus der Datenbank in die Variable $Fragen laden -->
    <?php $fragen = DB::table('fragenkatalogs')->select('frage', 'fragen_id', 'antworten', 'richtig')->where('Kategorie', 'technik')->get() ?>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Testfragen - Technik</div>
                    <div class="card-body" id="cardBody">
                        <!-- Ausgabe der Fragen mit Kategorie = Technik-->
                        <script>generateQuestions(<?php echo $fragen;?>, 'technik')</script>
                    </div>
                </div>
            </div>
        </div>
