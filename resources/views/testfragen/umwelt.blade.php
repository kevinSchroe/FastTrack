        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    @foreach($fragenkatalogs = DB::table('fragenkatalogs')->select('frage', 'fragen_id', 'richtige_antwort', 'erste_falsche_antwort', 'zweite_falsche_antwort')->where('Kategorie', 'Umwelt') -> get() as $fragenkatalog)
