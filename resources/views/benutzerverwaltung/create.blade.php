...
@section('content')
    ...
    <div class="form-group">
        ...
        {{ Form::select('role', array('0' => 'Wähle eine Role', '1' => 'Admin', '2' => 'Fahrlehrer', '3' => 'Fahrschueler'), old('nerd_level'), array('class' => 'form-control')) }}
    </div>
    ...
    <div class="form-group">
        {{ Form::label('BIC', 'BIC') }}
        {{ Form::email('BIC', old('BIC'), array('class' => 'form-control')) }}
    </div>
